//lifetimes are not scopes.
//They describe a relationship between an object that contains a reference and the object that is being referenced.
/*
Lifetimes track who depends on who.
If A depends on B, A must not live longer than B.
Scenario
